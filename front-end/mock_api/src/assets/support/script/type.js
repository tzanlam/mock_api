...
let titleProduct = document.querySelector('.title-list')
let productType = new URLSearchParams(window.location.search).get('id')
let title = ""
...
switch(productType){
    case "A":
        ...
        break
    case "ASM":
        title = "Tất cả Áo Sơ Mi"
        break
    case "AT":
        title = "Tất cả Áo Thun"
        break
    case "AK":
        title = "Tất cả Áo Kiểu"
        break
    case "ABZ":
        title = "Tất cả Áo Khoác-Blazer"
        break
    case "Q":
        title = "Tất cả Quần & Chân Váy"
        break
    case "QD":
        title = "Tất cả Quần Dài"
        break
    case "QS":
        title = "Tất cả Quần Shorts"
        break
    case "QV":
        title = "Tất cả Chân Váy"
        break
    case "QJ":
        title = "Tất cả Quần Jeans"
        break
    case "G":
        title = "Tất cả Giày"
        break
    case "GXD":
        title = "Tất cả Giày Xăng Đan"
        break
    case "GCG":
        title = "Tất cả Giày Cao Gót"
        break
    case "GSK":
        title = "Tất cả Giày Sneakers"
        break
    case "GBB":
        title = "Tất cả Giày Búp Bê"
        break
    case "T":
        title = "Tất cả Túi"
        break
    case "TCN":
        title = "Tất cả Túi Cỡ Nhỏ"
        break
    case "TCT":
        title = "Tất cả Túi Cỡ Trung"
        break
    case "TCL":
        title = "Tất cả Túi Cỡ Lớn"
        break
    case "TBL":
        title = "Tất cả Balo"
        break
...
titleProduct.innerText = title
    function addDataToHTML(){       
        ...
        products.forEach(product => {
            ...
            let type = product.id.substring(0,productType.length)         
